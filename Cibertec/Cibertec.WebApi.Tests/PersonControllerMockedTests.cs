...
{
    public class PersonControllerMockedTests
    {
        private readonly PersonController _personController;
        private readonly IUnitOfWork _uniMocked;

        public PersonControllerMockedTests()
        {
        ...
        [Fact(DisplayName = "[PersonControllerMocked] Get List")]
        ...
        [Fact(DisplayName = "[PersonControllerMocked] Insert")]
        ...
        [Fact(DisplayName = "[PersonControllerMocked] Update")]
        ...
        [Fact(DisplayName = "[PersonControllerMocked] Delete")]
